...
FIELD_GROUPS = [
    ("ข้อมูลระบุสาร", [
        ...
        # ค่านี้จะไปวางลงบน PDF ตรงช่องที่ Template.pdf พิมพ์ป้ายว่า "ชื่อทางการค้า:" ไว้ (ดูคอมเมนต์ใน
        # fill_template.py) แต่ในฟอร์มเว็บตั้งชื่อป้ายให้ตรงกับสิ่งที่กรอกจริงแทน (ชื่อสารเคมี ไม่ใช่ชื่อ
        # การค้า) เพราะผู้ใช้สับสนว่าดูเหมือนสลับกับช่อง trade_name ด้านบน (ที่เป็นชื่อการค้า/แบรนด์จริงๆ)
        ("ingredient_name", "ชื่อสารเคมี (คู่กับ CAS No ด้านล่าง)", False),
